...
* [Astropy](https://github.com/astropy/astropy) ⭐ 5,295 | 🐛 1,430 | 🌐 Python | 📅 2026-09-02 - Repository for the Astropy core package.
* [Celestia](https://github.com/CelestiaProject/Celestia) ⭐ 2,355 | 🐛 145 | 🌐 C++ | 📅 2026-09-01 - Real-time 3D visualization of space.
* [Allsky Camera](https://github.com/thomasjacquin/allsky) ⭐ 1,599 | 🐛 55 | 🌐 JavaScript | 📅 2026-08-31 - A Raspberry Pi operated Wireless Allsky Camera.
...
* [OpenSpace](https://github.com/OpenSpace/OpenSpace) ⭐ 1,243 | 🐛 733 | 🌐 C++ | 📅 2026-09-01 - An open source astrovisualization project.
...
* [SunPy](https://github.com/sunpy/sunpy) ⭐ 1,033 | 🐛 277 | 🌐 Python | 📅 2026-09-01 - Python for Solar Physics.
* [Astroquery](https://github.com/astropy/astroquery) ⭐ 790 | 🐛 417 | 🌐 Python | 📅 2026-08-28 - Functions and classes to access online data resources.
* [Astronomy for Meteor](https://github.com/jagi/meteor-astronomy) ⭐ 604 | 🐛 47 | 🌐 JavaScript | 📅 2023-08-24 - Model layer for Meteor.
* [Lightkurve](https://github.com/KeplerGO/lightkurve) ⭐ 531 | 🐛 188 | 🌐 Python | 📅 2026-08-25 - A friendly package for Kepler & TESS time series analysis in Python.
...
* [galpy](https://github.com/jobovy/galpy) ⭐ 284 | 🐛 23 | 🌐 Python | 📅 2026-09-02 - Galactic Dynamics in Python.
* [INDIGO](https://github.com/indigo-astronomy/indigo) ⭐ 201 | 🐛 65 | 🌐 C | 📅 2026-09-02 - A system of standards and frameworks for multiplatform and distributed astronomy software development designed to scale with your needs.
