...
* [English](https://github.com/mbiesiad/awesome-astronomy) ⭐ 97 | 🐛 3 | 📅 2026-06-01
* [Polish](https://github.com/mbiesiad/awesome-astronomy/tree/pl_PL) ⭐ 97 | 🐛 3 | 📅 2026-06-01
...
* [Astropy](https://github.com/astropy/astropy) ⭐ 5,267 | 🐛 1,421 | 🌐 Python | 📅 2026-08-12 - Repository for the Astropy core package.
* [Celestia](https://github.com/CelestiaProject/Celestia) ⭐ 2,338 | 🐛 146 | 🌐 C++ | 📅 2026-08-12 - Real-time 3D visualization of space.
* [Allsky Camera](https://github.com/thomasjacquin/allsky) ⭐ 1,589 | 🐛 55 | 🌐 JavaScript | 📅 2026-08-09 - A Raspberry Pi operated Wireless Allsky Camera.
* [Mapping The Solar System](https://github.com/eleanorlutz/asteroids_atlas_of_space) ⭐ 1,305 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2022-11-12 - Code, data, and instructions for mapping orbits of asteroids in the solar system.
* [OpenSpace](https://github.com/OpenSpace/OpenSpace) ⭐ 1,226 | 🐛 681 | 🌐 C++ | 📅 2026-08-12 - An open source astrovisualization project.
* [Astronomy Picture of the Day (APOD) microservice](https://github.com/nasa/apod-api) ⭐ 1,074 | 🐛 8 | 🌐 Python | 📅 2026-07-21 - Astronomy Picture of the Day API service.
* [SunPy](https://github.com/sunpy/sunpy) ⭐ 1,032 | 🐛 273 | 🌐 Python | 📅 2026-08-12 - Python for Solar Physics.
* [Astroquery](https://github.com/astropy/astroquery) ⭐ 786 | 🐛 410 | 🌐 Python | 📅 2026-08-08 - Functions and classes to access online data resources.
* [Astronomy for Meteor](https://github.com/jagi/meteor-astronomy) ⭐ 604 | 🐛 47 | 🌐 JavaScript | 📅 2023-08-24 - Model layer for Meteor.
* [Lightkurve](https://github.com/KeplerGO/lightkurve) ⭐ 521 | 🐛 189 | 🌐 Python | 📅 2026-07-08 - A friendly package for Kepler & TESS time series analysis in Python.
...
* [WebbCompare](https://github.com/JohnEdChristensen/WebbCompare) ⭐ 434 | 🐛 8 | 🌐 JavaScript | 📅 2024-03-01 - Comparison James Webb Space Telescope images with older images.
* [The Solar System](https://github.com/sanderblue/solar-system-threejs) ⭐ 409 | 🐛 14 | 🌐 JavaScript | 📅 2022-12-07 - The Solar System: Modeled to scale with Three.js.
...
* [astro-rust](https://github.com/saurvs/astro-rust) ⭐ 314 | 🐛 11 | 🌐 Rust | 📅 2019-10-20 - Astronomical algorithms in Rust.
* [galpy](https://github.com/jobovy/galpy) ⭐ 281 | 🐛 7 | 🌐 Python | 📅 2026-08-13 - Galactic Dynamics in Python.
* [INDIGO](https://github.com/indigo-astronomy/indigo) ⭐ 197 | 🐛 80 | 🌐 C | 📅 2026-08-12 - A system of standards and frameworks for multiplatform and distributed astronomy software development designed to scale with your needs.
...
* [astronomia](https://github.com/commenthol/astronomia) ⭐ 177 | 🐛 12 | 🌐 JavaScript | 📅 2025-08-30 - An astronomical library.
* [find\_orb](https://github.com/Bill-Gray/find_orb) ⭐ 120 | 🐛 25 | 🌐 C++ | 📅 2026-07-23 - Orbit determination from observation.
* [PyTransit](https://github.com/hpparvi/PyTransit) ⭐ 110 | 🐛 6 | 🌐 Jupyter Notebook | 📅 2026-07-06 - Fast and easy exoplanet transit light curve modelling.
* [gaia\_tools](https://github.com/jobovy/gaia_tools) ⚠️ Archived - Tools for working with the ESA Gaia data and related data sets.
* [Gaia Sky](https://github.com/langurmonkey/gaiasky) ⭐ 13 | 🐛 0 | 🌐 Java | 📅 2026-08-11 - Mirror of Gaia Sky repository hosted on GitLab.
...
* [Las Cumbres Observatory](https://github.com/lcogt) - GH account of Las Cumbres Observatory (LCO) org.
...
* [NASA\_DEVELOP](https://twitter.com/NASA_DEVELOP) - NASA Applied Sciences Program that conducts research projects applying NASA Earth observations to environmental policy issues around the globe.
...
* [Eduardo Machado Pereira](https://twitter.com/mp_eduard) - astronomer at the Valongo Observatory and PhD at the National Observatory. User: @mp\_eduard Language: Portuguese-BR.
...
* [Roberta Duarte](https://twitter.com/import_robs) - Physics. PhD student in Astrophysics at @blackholesusp.Working and promoting black holes and AI (on #AstroThreadBR). Itineraries in Ciência Todo Dia. User: @import\_robs. Language: Portuguese-BR and English.
...
* [Sofia Fonseca](https://twitter.com/sofia_fonsecao) - Astronomy student at UFRJ, amateur astrophotographer and science communicator. User: @sofia\_fonsecao. Language: Portuguese-BR.
