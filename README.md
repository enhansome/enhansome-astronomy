...
* [Astropy](https://github.com/astropy/astropy) ⭐ 5,276 | 🐛 1,426 | 🌐 Python | 📅 2026-08-18 - Repository for the Astropy core package.
* [Celestia](https://github.com/CelestiaProject/Celestia) ⭐ 2,344 | 🐛 147 | 🌐 C++ | 📅 2026-08-19 - Real-time 3D visualization of space.
* [Allsky Camera](https://github.com/thomasjacquin/allsky) ⭐ 1,594 | 🐛 55 | 🌐 JavaScript | 📅 2026-08-09 - A Raspberry Pi operated Wireless Allsky Camera.
* [Mapping The Solar System](https://github.com/eleanorlutz/asteroids_atlas_of_space) ⭐ 1,307 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2022-11-12 - Code, data, and instructions for mapping orbits of asteroids in the solar system.
* [OpenSpace](https://github.com/OpenSpace/OpenSpace) ⭐ 1,231 | 🐛 682 | 🌐 C++ | 📅 2026-08-20 - An open source astrovisualization project.
* [Astronomy Picture of the Day (APOD) microservice](https://github.com/nasa/apod-api) ⭐ 1,078 | 🐛 9 | 🌐 Python | 📅 2026-07-21 - Astronomy Picture of the Day API service.
* [SunPy](https://github.com/sunpy/sunpy) ⭐ 1,033 | 🐛 274 | 🌐 Python | 📅 2026-08-20 - Python for Solar Physics.
* [Astroquery](https://github.com/astropy/astroquery) ⭐ 789 | 🐛 413 | 🌐 Python | 📅 2026-08-13 - Functions and classes to access online data resources.
* [Astronomy for Meteor](https://github.com/jagi/meteor-astronomy) ⭐ 604 | 🐛 47 | 🌐 JavaScript | 📅 2023-08-24 - Model layer for Meteor.
* [Lightkurve](https://github.com/KeplerGO/lightkurve) ⭐ 525 | 🐛 190 | 🌐 Python | 📅 2026-07-08 - A friendly package for Kepler & TESS time series analysis in Python.
...
* [galpy](https://github.com/jobovy/galpy) ⭐ 283 | 🐛 14 | 🌐 Python | 📅 2026-08-21 - Galactic Dynamics in Python.
* [INDIGO](https://github.com/indigo-astronomy/indigo) ⭐ 199 | 🐛 81 | 🌐 C | 📅 2026-08-20 - A system of standards and frameworks for multiplatform and distributed astronomy software development designed to scale with your needs.
