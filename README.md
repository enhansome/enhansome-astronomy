...
* [Astropy](https://github.com/astropy/astropy) ⭐ 5,300 | 🐛 1,429 | 🌐 Python | 📅 2026-09-08 - Repository for the Astropy core package.
* [Celestia](https://github.com/CelestiaProject/Celestia) ⭐ 2,358 | 🐛 147 | 🌐 C++ | 📅 2026-09-07 - Real-time 3D visualization of space.
* [Allsky Camera](https://github.com/thomasjacquin/allsky) ⭐ 1,605 | 🐛 56 | 🌐 JavaScript | 📅 2026-08-31 - A Raspberry Pi operated Wireless Allsky Camera.
...
* [OpenSpace](https://github.com/OpenSpace/OpenSpace) ⭐ 1,246 | 🐛 742 | 🌐 C++ | 📅 2026-09-08 - An open source astrovisualization project.
* [Astronomy Picture of the Day (APOD) microservice](https://github.com/nasa/apod-api) ⭐ 1,082 | 🐛 11 | 🌐 Python | 📅 2026-07-21 - Astronomy Picture of the Day API service.
* [SunPy](https://github.com/sunpy/sunpy) ⭐ 1,034 | 🐛 281 | 🌐 Python | 📅 2026-09-03 - Python for Solar Physics.
* [Astroquery](https://github.com/astropy/astroquery) ⭐ 791 | 🐛 417 | 🌐 Python | 📅 2026-09-04 - Functions and classes to access online data resources.
* [Astronomy for Meteor](https://github.com/jagi/meteor-astronomy) ⭐ 604 | 🐛 47 | 🌐 JavaScript | 📅 2023-08-24 - Model layer for Meteor.
* [Lightkurve](https://github.com/KeplerGO/lightkurve) ⭐ 531 | 🐛 190 | 🌐 Python | 📅 2026-08-25 - A friendly package for Kepler & TESS time series analysis in Python.
...
* [WebbCompare](https://github.com/JohnEdChristensen/WebbCompare) ⭐ 434 | 🐛 14 | 🌐 JavaScript | 📅 2024-03-01 - Comparison James Webb Space Telescope images with older images.
...
* [galpy](https://github.com/jobovy/galpy) ⭐ 284 | 🐛 24 | 🌐 Python | 📅 2026-09-09 - Galactic Dynamics in Python.
* [INDIGO](https://github.com/indigo-astronomy/indigo) ⭐ 201 | 🐛 66 | 🌐 C | 📅 2026-09-08 - A system of standards and frameworks for multiplatform and distributed astronomy software development designed to scale with your needs.
...
* [PyTransit](https://github.com/hpparvi/PyTransit) ⭐ 110 | 🐛 6 | 🌐 Jupyter Notebook | 📅 2026-09-08 - Fast and easy exoplanet transit light curve modelling.
* [gaia\_tools](https://github.com/jobovy/gaia_tools) ⚠️ Archived - Tools for working with the ESA Gaia data and related data sets.
* [Gaia Sky](https://github.com/langurmonkey/gaiasky) ⭐ 13 | 🐛 0 | 🌐 Java | 📅 2026-09-04 - Mirror of Gaia Sky repository hosted on GitLab.
