...
* [Astropy](https://github.com/astropy/astropy) ⭐ 5,314 | 🐛 1,417 | 🌐 Python | 📅 2026-09-24 - Repository for the Astropy core package.
* [Celestia](https://github.com/CelestiaProject/Celestia) ⭐ 2,367 | 🐛 146 | 🌐 C++ | 📅 2026-09-24 - Real-time 3D visualization of space.
* [Allsky Camera](https://github.com/thomasjacquin/allsky) ⭐ 1,623 | 🐛 52 | 🌐 JavaScript | 📅 2026-09-24 - A Raspberry Pi operated Wireless Allsky Camera.
...
* [OpenSpace](https://github.com/OpenSpace/OpenSpace) ⭐ 1,256 | 🐛 753 | 🌐 C++ | 📅 2026-09-24 - An open source astrovisualization project.
* [Astronomy Picture of the Day (APOD) microservice](https://github.com/nasa/apod-api) ⭐ 1,089 | 🐛 13 | 🌐 Python | 📅 2026-09-18 - Astronomy Picture of the Day API service.
* [SunPy](https://github.com/sunpy/sunpy) ⭐ 1,036 | 🐛 295 | 🌐 Python | 📅 2026-09-21 - Python for Solar Physics.
* [Astroquery](https://github.com/astropy/astroquery) ⭐ 793 | 🐛 414 | 🌐 Python | 📅 2026-09-24 - Functions and classes to access online data resources.
* [Astronomy for Meteor](https://github.com/jagi/meteor-astronomy) ⭐ 602 | 🐛 47 | 🌐 JavaScript | 📅 2023-08-24 - Model layer for Meteor.
* [Lightkurve](https://github.com/KeplerGO/lightkurve) ⭐ 534 | 🐛 191 | 🌐 Python | 📅 2026-09-16 - A friendly package for Kepler & TESS time series analysis in Python.
...
* [galpy](https://github.com/jobovy/galpy) ⭐ 284 | 🐛 30 | 🌐 Python | 📅 2026-09-25 - Galactic Dynamics in Python.
* [INDIGO](https://github.com/indigo-astronomy/indigo) ⭐ 204 | 🐛 66 | 🌐 C | 📅 2026-09-24 - A system of standards and frameworks for multiplatform and distributed astronomy software development designed to scale with your needs.
...
* [Gaia Sky](https://github.com/langurmonkey/gaiasky) ⭐ 13 | 🐛 0 | 🌐 Java | 📅 2026-09-24 - Mirror of Gaia Sky repository hosted on GitLab.
