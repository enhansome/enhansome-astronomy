...
* [Astropy](https://github.com/astropy/astropy) ⭐ 5,275 | 🐛 1,426 | 🌐 Python | 📅 2026-08-15 - Repository for the Astropy core package.
* [Celestia](https://github.com/CelestiaProject/Celestia) ⭐ 2,340 | 🐛 147 | 🌐 C++ | 📅 2026-08-15 - Real-time 3D visualization of space.
* [Allsky Camera](https://github.com/thomasjacquin/allsky) ⭐ 1,590 | 🐛 55 | 🌐 JavaScript | 📅 2026-08-09 - A Raspberry Pi operated Wireless Allsky Camera.
* [Mapping The Solar System](https://github.com/eleanorlutz/asteroids_atlas_of_space) ⭐ 1,306 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2022-11-12 - Code, data, and instructions for mapping orbits of asteroids in the solar system.
* [OpenSpace](https://github.com/OpenSpace/OpenSpace) ⭐ 1,229 | 🐛 681 | 🌐 C++ | 📅 2026-08-14 - An open source astrovisualization project.
* [Astronomy Picture of the Day (APOD) microservice](https://github.com/nasa/apod-api) ⭐ 1,076 | 🐛 8 | 🌐 Python | 📅 2026-07-21 - Astronomy Picture of the Day API service.
* [SunPy](https://github.com/sunpy/sunpy) ⭐ 1,032 | 🐛 274 | 🌐 Python | 📅 2026-08-13 - Python for Solar Physics.
* [Astroquery](https://github.com/astropy/astroquery) ⭐ 788 | 🐛 410 | 🌐 Python | 📅 2026-08-13 - Functions and classes to access online data resources.
* [Astronomy for Meteor](https://github.com/jagi/meteor-astronomy) ⭐ 604 | 🐛 47 | 🌐 JavaScript | 📅 2023-08-24 - Model layer for Meteor.
* [Lightkurve](https://github.com/KeplerGO/lightkurve) ⭐ 524 | 🐛 189 | 🌐 Python | 📅 2026-07-08 - A friendly package for Kepler & TESS time series analysis in Python.
...
* [The Solar System](https://github.com/sanderblue/solar-system-threejs) ⭐ 410 | 🐛 14 | 🌐 JavaScript | 📅 2022-12-07 - The Solar System: Modeled to scale with Three.js.
...
* [galpy](https://github.com/jobovy/galpy) ⭐ 283 | 🐛 13 | 🌐 Python | 📅 2026-08-16 - Galactic Dynamics in Python.
* [INDIGO](https://github.com/indigo-astronomy/indigo) ⭐ 197 | 🐛 80 | 🌐 C | 📅 2026-08-15 - A system of standards and frameworks for multiplatform and distributed astronomy software development designed to scale with your needs.
...
* [find\_orb](https://github.com/Bill-Gray/find_orb) ⭐ 120 | 🐛 25 | 🌐 C++ | 📅 2026-08-16 - Orbit determination from observation.
